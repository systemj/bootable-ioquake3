...
make_efi() {
    ...
    sed "s|%ARCHISO_LABEL%|${iso_label}|g;
         s|%INSTALL_DIR%|${install_dir}|g" \
        ${script_path}/efiboot/loader/entries/archiso-x86_64-usb-server.conf > ${work_dir}/iso/loader/entries/archiso-x86_64-server.conf
...
make_efiboot() {
    ...
    sed "s|%ARCHISO_LABEL%|${iso_label}|g;
         s|%INSTALL_DIR%|${install_dir}|g" \
        ${script_path}/efiboot/loader/entries/archiso-x86_64-cd-server.conf > ${work_dir}/efiboot/loader/entries/archiso-x86_64-server.conf
